...
@Component({
  selector: 'app-feedback-config-settings',
  templateUrl: './feedback-config.component.html',
  styleUrls: ['./feedback-config.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class FeedbackConfigSettingsComponent implements OnInit {
  ...
  @Input() public childName: string;
    ...
    // --------------------------------------------------------
  @Input() public selectedSubMerchant: string;
  config: any;
  ...
  //  }));
    ...
    if(this.selectedSubMerchant === undefined || this.selectedSubMerchant === null){

export class ChatDB {
  ...
  static chatUser = [
    ...
    },
    {
      ...
      profile: 'assets/img/user/12.png',
      seen: 'online',
      online: true,
      typing: false,
      authenticate: 0,
    ...
    },
    {
      ...
      profile: 'assets/img/user/11.png',
    ...
    },
    {
      ...
      name: 'Jaclin Thomas',
      status: 'Single..',
      profile: 'assets/img/user/10.jpg',
